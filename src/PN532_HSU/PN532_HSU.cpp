...
//    }
    ...
    putchar(PN532_PREAMBLE);
    putchar(PN532_STARTCODE1);
    putchar(PN532_STARTCODE2);
    
    uint8_t length = hlen + blen + 1;   // length of data field: TFI + DATA
    putchar(length);
    putchar(~length + 1);         // checksum of length
    
    putchar(PN532_HOSTTOPN532);
